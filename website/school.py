...
class Student:
    def __init__(self,root):
        ...
        title = Label(w,text="Visit: CodeWithCurious.com/projects for more projects",bd=3,relief=GROOVE,font=("Brush Script MT",18),bg='blue',fg='white' )
      ...
      #w=Tk()
       #w.title(" student registration system")
        manage_frame = Label(w,bd=4,relief=RIDGE,bg='light blue')
