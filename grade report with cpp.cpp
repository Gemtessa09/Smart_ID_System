	...
	int main()
	{
		...
		cout<<"====================================================\n";
			...
			cout<<"    THIS PROGRAMMING OF STUDENT REPORT\n\n";
	...
	void Student_Info()
	{
		...
		for(i=0;i<n;i++)
		{
			...
			cin>>s[i].fname;
			cout<<"Enter student_"<<i+1<<" Middle name: ";
			cin>>s[i].MiddleN;
			...
			cout<<"Enter student_"<<i+1<<" Semester(in char): ";
			cin>>s[i].semester;
	...
	void CourseMark()
	{
		...
		for(int i=0;i<n;i++)
		{
			cout<<"Enter student_"<<i+1<<" programming I mark:\n";
	...
	void Display_GradeRport()
	{
		...
		for(i=0;i<n;i++)
		{
			cout<<"Full Name: "<<s[i].fname<<"\t"<<s[i].MiddleN<<"\t "<<s[i].lname<<"\t"<<"\tYear:"<<s[i].year<<"\tSemester: "<<s[i].semester<<endl;
